...
import {View,Text,StyleSheet,TouchableOpacity,Image,ScrollView,FlatList,Pressable, Dimensions,StatusBar} from "react-native";
                ...
                <View>
                    <FlatList 
                        ...
                        renderItem={({item,index})=>(
                            ...
                            >
                                <View style={indexCheck === item.id ?{...styles.smallCardelected}:{...styles.smallCard}}>
                                    <Image 
